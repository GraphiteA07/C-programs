...
int main() {
    ...
    struct UserDetails Ryan, Shayan, Ahmed, Khuzema,
                       Fawad, Talha, Muaz, Ali,
                       Saffi, Muzammil, Burhan, Tanveer,
                       Ar_ryan, Umair, Zuhair, Mahad,
                       Rafay,Ubaid;
    ...
    struct UserDetails user_data[MEMORY]= {Ryan, Shayan, Ahmed, Khuzema,
                                           Fawad, Talha, Muaz, Ali,
                                           Saffi, Muzammil, Burhan, Tanveer,
                                           Ar_ryan, Umair, Zuhair, Mahad,
                                           Rafay, Ubaid};
