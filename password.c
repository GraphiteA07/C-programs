...
Main_Display:
 ...
 /* printf("\n (R : %d)  (F : %d)  (K : %d)  (T : %d)  (Ahme : %d)  (M : %d)  (S : %d) ",Ryan.Found,Fawad.Found,Khuzema.Found,Talha.Found,Ahmed.Found,Muaz.Found,Shayan.Found); */
  ...
  if ( choice == 50 ) {  // Means 2;
   ...
   if ( Ryan.AccountBalance <= 0 || Shayan.AccountBalance <= 0 || Ahmed.AccountBalance <= 0 || Khuzema.AccountBalance <= 0 || Muaz.AccountBalance <= 0 || Talha.AccountBalance <= 0 || Fawad.AccountBalance <= 0 ) {
   ...
   if (Ryan.Found) {
    ...
    if ( Ryan.AccountBalance <= 0 ) {
     Ryan.AccountBalance = 0;
    }
   ...
   if (Shayan.Found) {
    ...
    if ( Shayan.AccountBalance <= 0 ) {
     Shayan.AccountBalance = 0;
    }
   ...
   if (Ahmed.Found) {
    ...
    if ( Ahmed.AccountBalance <= 0 ) {
     Ahmed.AccountBalance = 0;
    }
   ...
   if (Fawad.Found) {
    ...
    if ( Fawad.AccountBalance <= 0 ) {
     Fawad.AccountBalance = 0;
    }
   ...
   if (Talha.Found) {
    ...
    if ( Talha.AccountBalance <= 0 ) {
     Talha.AccountBalance = 0;
    }
   ...
   if (Khuzema.Found) {
    ...
    if ( Khuzema.AccountBalance <= 0 ) {
     Khuzema.AccountBalance = 0;
    }
   ...
   if (Muaz.Found) {
    ...
    if ( Muaz.AccountBalance <= 0 ) {
     Muaz.AccountBalance = 0;
    }
